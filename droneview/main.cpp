...
static GLfloat lookatAngleX = 0.0;
static GLfloat lookatAngleY = 0.0;
...
void display(void)
{
   ...
   glLoadIdentity();
   gluLookAt(	-g_fViewDistance * sin(lookatAngleX) * cos(lookatAngleY),
				-g_fViewDistance * sin(lookatAngleY),
				-g_fViewDistance * cos(lookatAngleX) * cos(lookatAngleY),
				0, 0, 0,		// Center Point
				0, 1, 0);		// Up Vector
...
int main(int argc, char** argv)
{
  ...
  glutCreateWindow ("GLUT Droneview");
